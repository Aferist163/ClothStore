...
async function handleRegister(event) {
    ...
    try {
        ...
        const response = await fetch('http://localhost/ClothStore/api/register.php', {
            method: 'POST',
...
async function handleLogin(event) {
    ...
    try {
        ...
        const response = await fetch('http://localhost/ClothStore/api/login.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data)
        });
...
async function loadProfile() {
    try {
        ...
        const response = await fetch('http://localhost/ClothStore/api/auth_check.php');
...
async function handleLogout() {
    ...
    try {
        ...
        const response = await fetch('http://localhost/ClothStore/api/logout.php', {
            method: 'POST'
        });
